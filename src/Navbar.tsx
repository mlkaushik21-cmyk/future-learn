          ...
          <div className="flex items-center gap-4">
            {user ? (
              <div className="hidden sm:flex items-center gap-4">
                <div className="bg-green-50 text-green-700 px-3 py-1.5 rounded-lg font-medium border border-green-200">
                  {user.email}
                </div>
                <button onClick={handleLogout} className="text-red-600 hover:bg-red-50 px-4 py-2 rounded-lg font-medium transition flex items-center gap-2">
                  <LogOut size={18} />
                  <span>Logout</span>
                </button>
              </div>
